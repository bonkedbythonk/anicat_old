...
# Single source of truth: anicat_media/_version.py (auto-generated by bump-version.sh).
# Baked into Python bytecode so it's always available, even in PyInstaller bundles.
from anicat_media._version import __version__  # noqa: PLC0415
VERSION = __version__
